...
public class adminResolvedTotalView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_resolved_total_view);
        ...
        FirebaseDatabase.getInstance().getReference().child("management").child("Queries").child("resolvedcomplaint").child(a).child(b).addValueEventListener(new ValueEventListener() {
            @Override
