...
public class totalComplaintDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_complaint_detail);
        ...
        FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid()).child("totalcomplaint").child(tempPath).addValueEventListener(new ValueEventListener() {
            @Override
